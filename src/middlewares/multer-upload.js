...
export const uploadProfilePicture = createMulterConfig("../public/upLoads/profile-pintures")
export const uploadPetPinture = createMulterConfig("../../public/upLoads/pet-pictures")